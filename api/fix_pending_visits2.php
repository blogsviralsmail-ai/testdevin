...
if ($_SERVER["REQUEST_METHOD"] === "GET") {
    try {
        ...
        echo json_encode(["success" => false, "message" => "Failed to fetch pending visits: " . $e->getMessage()]);
    }
    exit;
}
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($action === "approve") {
        ...
        try {
            ...
            $pdo->rollBack();
            echo json_encode(["success" => false, "message" => "Failed to approve visit: " . $e->getMessage()]);
        }
        ...
        try {
            ...
            echo json_encode(["success" => false, "message" => "Failed to reject visit: " . $e->getMessage()]);
        }
    } else {
