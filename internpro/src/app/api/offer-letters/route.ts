...
${LH}
<div style="${PC}">
<table style="width:100%;margin-bottom:10px;"><tr><td style="font-size:15px;color:#555;">Ref: <strong style="color:#222;">{{letter_number}}</strong></td><td style="text-align:right;font-size:15px;color:#555;">Date: <strong style="color:#222;">${todayDate}</strong></td></tr></table>
...
<p style="font-size:17px;color:#333;margin:10px 0 8px;">Dear <strong style="color:#0000AA;">{{student_name}}</strong>,</p>
<p style="font-size:16px;color:#333;line-height:1.6;text-align:justify;margin:0 0 10px;">With reference to your application and subsequent interactions, we are pleased to offer you an internship position at <strong>${escapeHtml(lhCompany)}</strong> for the <strong>{{program_name}}</strong> program. This offer is subject to the following terms and conditions outlined below.</p>
...
<tr><td style="padding:6px 14px;border:1px solid #e0e0e0;font-weight:600;color:#333;background:#fafbff;">Program</td><td style="padding:6px 14px;border:1px solid #e0e0e0;">{{program_name}}</td></tr>
...
<tr><td style="padding:6px 14px;border:1px solid #e0e0e0;font-weight:600;color:#333;background:#fafbff;">Date of Joining</td><td style="padding:6px 14px;border:1px solid #e0e0e0;">${joiningDateFormatted}</td></tr>
<tr><td style="padding:6px 14px;border:1px solid #e0e0e0;font-weight:600;color:#333;background:#fafbff;">Work Timing</td><td style="padding:6px 14px;border:1px solid #e0e0e0;">{{work_timing}}</td></tr>
...
<tr><td style="padding:6px 14px;border:1px solid #e0e0e0;font-weight:600;color:#333;background:#fafbff;">Paid Leaves</td><td style="padding:6px 14px;border:1px solid #e0e0e0;">{{paid_leaves}} per month</td></tr>
...
<p style="font-size:16px;color:#333;line-height:1.6;text-align:justify;margin:0 0 18px;">We look forward to your valuable association with ${escapeHtml(lhCompany)} and wish you a highly productive and rewarding internship experience with us.</p>
<p style="margin:14px 0 0;font-size:17px;color:#333;">For &amp; on behalf of <strong style="color:#0000AA;">${escapeHtml(lhCompany)}</strong>,</p>
...
<p style="font-size:15px;color:#333;line-height:1.6;margin:0 0 18px;">I, <strong>{{student_name}}</strong>, hereby accept the above-mentioned terms and conditions and agree to abide by all policies, rules, and regulations of ${escapeHtml(lhCompany)} during the course of my internship.</p>
<table style="width:100%;font-size:15px;color:#555;"><tr><td style="width:50%;padding:4px 0;">Signature: ________________________</td><td style="width:50%;padding:4px 0;">Date: ________________________</td></tr><tr><td style="padding:4px 0;">Name: {{student_name}}</td><td></td></tr></table>
</div>
</div>
<div style="flex-shrink:0;">${FT}</div>
</div>
