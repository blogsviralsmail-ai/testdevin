...
<div style="background:#f5f5f5;padding:8px 14px;margin-bottom:12px;display:flex;justify-content:space-between;align-items:center;"><span style="font-size:13px;color:#555;">Ref: <strong style="color:#222;">{{letter_number}}</strong></span><span style="font-size:13px;color:#555;">Date: <strong style="color:#222;">${todayDate}</strong></span></div>
...
<p style="font-size:14px;color:#333;margin:0 0 8px;">Dear <strong style="color:#0000AA;">{{student_name}}</strong>,</p>
<p style="font-size:13px;color:#333;line-height:1.5;text-align:justify;margin:0 0 12px;">With reference to your application and subsequent interactions, we are pleased to offer you an internship position at <strong>${escapeHtml(lhCompany)}</strong> for the <strong>{{program_name}}</strong> program. This offer is subject to the following terms and conditions outlined below.</p>
...
<tr><td style="padding:6px 12px;border:1px solid #e0e0e0;font-weight:600;color:#333;background:#fafbff;">Program</td><td style="padding:6px 12px;border:1px solid #e0e0e0;">{{program_name}}</td></tr>
...
<tr><td style="padding:6px 12px;border:1px solid #e0e0e0;font-weight:600;color:#333;">Work Timing</td><td style="padding:6px 12px;border:1px solid #e0e0e0;">{{work_timing}}</td></tr>
...
<tr><td style="padding:6px 12px;border:1px solid #e0e0e0;font-weight:600;color:#333;">Paid Leaves</td><td style="padding:6px 12px;border:1px solid #e0e0e0;">{{paid_leaves}} per month</td></tr>
...
<p style="font-size:13px;color:#333;line-height:1.5;text-align:justify;margin:0 0 8px;">We look forward to your valuable association with ${escapeHtml(lhCompany)} and wish you a highly productive and rewarding internship experience with us.</p>
<p style="margin:6px 0 0;font-size:13px;color:#333;">For &amp; on behalf of <strong style="color:#0000AA;">${escapeHtml(lhCompany)}</strong>,</p>
<div style="margin-top:4px;">
${sigBlock}
${signatoryName ? `<p style="margin:0;font-weight:700;color:#0000AA;font-size:17px;">${escapeHtml(signatoryName)}</p>` : ""}
...
<p style="font-size:13px;color:#333;line-height:1.5;margin:0 0 5px;">I, <strong>{{student_name}}</strong>, hereby accept the above-mentioned terms and conditions and agree to abide by all policies, rules, and regulations of ${escapeHtml(lhCompany)} during the course of my internship.</p>
