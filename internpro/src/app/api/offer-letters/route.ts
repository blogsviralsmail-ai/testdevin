...
<div class="page-content">
  ...
  <p style="font-size: 13px; color: #333; margin: 14px 0 6px;">Dear <strong style="color: #0000AA;">{{student_name}}</strong>,</p>

  <p style="font-size: 12.5px; color: #333; line-height: 1.8; text-align: justify; margin: 0 0 12px;">
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 6px;">1. Position Details</p>
  <table style="width: 100%; border-collapse: collapse; margin: 0 0 14px; font-size: 12px; border: 1px solid #ddd;">
    ...
    <tr><td style="padding: 6px 12px; border: 1px solid #e0e0e0; font-weight: 600; color: #333; background: #fafbff;">Duration</td><td style="padding: 6px 12px; border: 1px solid #e0e0e0;">{{duration}} Days</td></tr>
    ...
    <tr><td style="padding: 6px 12px; border: 1px solid #e0e0e0; font-weight: 600; color: #333; background: #fafbff;">Work Timing</td><td style="padding: 6px 12px; border: 1px solid #e0e0e0;">{{work_timing}}</td></tr>
    ...
    <tr><td style="padding: 6px 12px; border: 1px solid #e0e0e0; font-weight: 600; color: #333; background: #fafbff;">Stipend / Compensation</td><td style="padding: 6px 12px; border: 1px solid #e0e0e0;"><strong>&#8377;{{salary}}</strong> per month</td></tr>
    <tr><td style="padding: 6px 12px; border: 1px solid #e0e0e0; font-weight: 600; color: #333; background: #fafbff;">Weekly Off</td><td style="padding: 6px 12px; border: 1px solid #e0e0e0;">{{weekoffs}} day(s)</td></tr>
    <tr><td style="padding: 6px 12px; border: 1px solid #e0e0e0; font-weight: 600; color: #333; background: #fafbff;">Paid Leaves</td><td style="padding: 6px 12px; border: 1px solid #e0e0e0;">{{paid_leaves}} per month</td></tr>
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 5px;">2. Reporting &amp; Probation</p>
  <p style="font-size: 12px; color: #333; line-height: 1.75; text-align: justify; margin: 0 0 8px;">
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 5px;">3. Code of Conduct</p>
  <p style="font-size: 12px; color: #333; line-height: 1.7; text-align: justify; margin: 0 0 3px;">You are expected to:</p>
  <ul style="font-size: 12px; color: #333; line-height: 1.7; margin: 0 0 8px; padding-left: 20px;">
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 5px;">4. Confidentiality &amp; Non-Disclosure</p>
  <p style="font-size: 12px; color: #333; line-height: 1.75; text-align: justify; margin: 0 0 8px;">
...
${letterheadHtml}
<div class="page-content">
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 10px 0 5px;">5. Intellectual Property</p>
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 5px;">6. Termination</p>
  <p style="font-size: 12px; color: #333; line-height: 1.75; text-align: justify; margin: 0 0 10px;">
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 5px;">7. General Terms</p>
  <ul style="font-size: 12px; color: #333; line-height: 1.75; margin: 0 0 10px; padding-left: 20px;">
  ...
  <p style="font-size: 14px; font-weight: 700; color: #0000AA; margin: 14px 0 5px;">8. Acceptance</p>
  <p style="font-size: 12px; color: #333; line-height: 1.75; text-align: justify; margin: 0 0 12px;">
  ...
  <p style="font-size: 12px; color: #333; line-height: 1.75; text-align: justify; margin: 0 0 16px;">
    We look forward to your association with {{company_name}} and wish you a rewarding internship experience.
  </p>

  <p style="margin: 24px 0 0; font-size: 12px; color: #333;">For &amp; on behalf of <strong style="color: #0000AA;">{{company_name}}</strong>,</p>
  <div style="margin-top: 10px;">
    ${sigBlock}
    <p style="margin: 0; font-weight: 700; color: #0000AA; font-size: 14px;">{{signatory_name}}</p>
    <p style="margin: 2px 0 0; font-size: 11px; color: #555;">{{signatory_designation}}</p>
    <p style="margin: 2px 0 0; font-size: 11px; color: #555;">{{company_name}}</p>
  </div>

  <div style="margin-top: 32px; padding-top: 14px; border-top: 1px dashed #ccc;">
    <p style="font-size: 13px; font-weight: 700; color: #0000AA; margin: 0 0 6px;">Intern&rsquo;s Acceptance</p>
    <p style="font-size: 11px; color: #333; line-height: 1.7; margin: 0 0 18px;">
