...
<div style="background:#f5f5f5;padding:6px 14px;margin-bottom:8px;display:flex;justify-content:space-between;align-items:center;"><span style="font-size:12px;color:#555;">Ref: <strong style="color:#222;">${letterNumber}</strong></span><span style="font-size:12px;color:#555;">Date: <strong style="color:#222;">${todayFormatted}</strong></span></div>
...
<tr><td style="padding:4px 10px;border:1px solid #e0e0e0;font-weight:600;color:#333;">Duration</td><td style="padding:4px 10px;border:1px solid #e0e0e0;">${enrollment.batch.program.duration} Days</td></tr>
...
${extraExpSection}
<p style="margin:8px 0 0;font-size:12px;color:#333;">For &amp; on behalf of <strong style="color:#0000AA;">${escapeHtml(lhCompany)}</strong>,</p>
<div style="margin-top:3px;">
${sigBlock}
${signatoryName ? `<p style="margin:0;font-weight:700;color:#0000AA;font-size:15px;">${escapeHtml(signatoryName)}</p>` : ""}
<p style="margin:1px 0 0;font-size:12px;color:#555;">${escapeHtml(signatoryDesignation)}</p>
