...
<body>
        ...
        <main class="mason-content">
            ...
            <div class="mason-welcome-card">
                ...
                <div class="welcome-info">
                    ...
                    <div class="welcome-actions" style="margin-top: 10px; display: flex; gap: 10px; flex-wrap: wrap;">
                        <button onclick="openEditProfile()" class="btn btn-sm" style="background: #c9a227; color: #000; padding: 8px 15px; border: none; border-radius: 5px; cursor: pointer;">
                            <i class="fas fa-edit"></i> Edit Profile
                        </button>
                        <a href="https://jptiles.in" target="_blank" class="btn btn-sm" style="background: #2d2d2d; color: #fff; padding: 8px 15px; border: none; border-radius: 5px; text-decoration: none;">
    ...
    <!-- Edit Profile Modal -->
    <div id="editProfileModal" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 1000; justify-content: center; align-items: center;">
        <div style="background: #1a1a1a; border-radius: 15px; padding: 30px; max-width: 500px; width: 90%; max-height: 90vh; overflow-y: auto;">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h3 style="color: #c9a227; margin: 0;">Edit Profile</h3>
                <button onclick="closeEditProfile()" style="background: none; border: none; color: #fff; font-size: 24px; cursor: pointer;">&times;</button>
            </div>
            <form id="editProfileForm" method="POST" action="update-profile.php" enctype="multipart/form-data">
                <div style="text-align: center; margin-bottom: 20px;">
                    <div id="profilePhotoPreview" style="width: 100px; height: 100px; border-radius: 50%; border: 3px solid #c9a227; margin: 0 auto 10px; overflow: hidden; background: #2d2d2d;">
                        <?php if (!empty($mason['photo'])): ?>
                        <img src="../uploads/customers/<?php echo $mason['photo']; ?>" style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
                        <i class="fas fa-user" style="font-size: 40px; color: #c9a227; line-height: 100px;"></i>
                        <?php endif; ?>
                    </div>
                    <label style="background: #c9a227; color: #000; padding: 8px 15px; border-radius: 5px; cursor: pointer; display: inline-block;">
                        <i class="fas fa-camera"></i> Change Photo
                        <input type="file" name="photo" accept="image/*" style="display: none;" onchange="previewPhoto(this)">
                    </label>
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="color: #999; display: block; margin-bottom: 5px;">Name</label>
                    <input type="text" name="name" value="<?php echo htmlspecialchars($mason['name']); ?>" style="width: 100%; padding: 12px; background: #2d2d2d; border: 1px solid #444; border-radius: 8px; color: #fff; box-sizing: border-box;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="color: #999; display: block; margin-bottom: 5px;">Mobile</label>
                    <input type="text" name="mobile" value="<?php echo htmlspecialchars($mason['mobile']); ?>" style="width: 100%; padding: 12px; background: #2d2d2d; border: 1px solid #444; border-radius: 8px; color: #fff; box-sizing: border-box;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="color: #999; display: block; margin-bottom: 5px;">Address</label>
                    <textarea name="address" rows="2" style="width: 100%; padding: 12px; background: #2d2d2d; border: 1px solid #444; border-radius: 8px; color: #fff; box-sizing: border-box; resize: none;"><?php echo htmlspecialchars($mason['address'] ?? ''); ?></textarea>
                </div>
                <hr style="border-color: #444; margin: 20px 0;">
                <h4 style="color: #fff; margin-bottom: 15px;">Change Password</h4>
                <div style="margin-bottom: 15px;">
                    <label style="color: #999; display: block; margin-bottom: 5px;">Current Password</label>
                    <input type="password" name="current_password" style="width: 100%; padding: 12px; background: #2d2d2d; border: 1px solid #444; border-radius: 8px; color: #fff; box-sizing: border-box;">
                </div>
                <div style="margin-bottom: 15px;">
                    <label style="color: #999; display: block; margin-bottom: 5px;">New Password</label>
                    <input type="password" name="new_password" style="width: 100%; padding: 12px; background: #2d2d2d; border: 1px solid #444; border-radius: 8px; color: #fff; box-sizing: border-box;">
                </div>
                <button type="submit" style="width: 100%; padding: 14px; background: #c9a227; color: #000; border: none; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer;">
                    Save Changes
                </button>
            </form>
        </div>
