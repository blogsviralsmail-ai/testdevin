        ...
        <div className="space-y-4">
          <div className="surface-base border rounded-lg p-6 space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              <a href={`${import.meta.env.VITE_API_URL || ''}/api/schedule/csv-template`} className="surface-muted text-secondary px-4 py-2 rounded-lg hover:bg-[rgb(var(--bg-muted))] text-sm">
                Download Template
              </a>
            </div>
