  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-primary">Reseller Management</h1>
      ...
      <div className="surface-base rounded-lg border">
        {resellers.length === 0 ? (
          <div className="p-8 text-center text-tertiary">No resellers yet</div>
        ) : (
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="surface-subtle">
                <tr>
                  <th className="px-4 py-3 text-left font-medium text-tertiary">Reseller</th>
                  <th className="px-4 py-3 text-left font-medium text-tertiary">Brand</th>
                  <th className="px-4 py-3 text-center font-medium text-tertiary">Commission</th>
                  <th className="px-4 py-3 text-center font-medium text-tertiary">Clients</th>
                  <th className="px-4 py-3 text-center font-medium text-tertiary">Actions</th>
                </tr>
              </thead>
              <tbody className="divide-y">
                {resellers.map((r: any) => (
                  <tr key={r.id} className="hover:bg-[rgb(var(--bg-muted))]">
