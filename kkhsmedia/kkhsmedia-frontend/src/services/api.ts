...
export const streamingAPI = {
  ...
  playlistFromUrls: (data: { slotId: string; urls: string[]; loop?: boolean }) => api.post('/api/streaming/playlist-from-urls', data),
  getPlaylistJobStatus: (jobId: string) => api.get(`/api/streaming/playlist-job/${jobId}`),
