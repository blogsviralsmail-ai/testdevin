...
package com.kkhsmedia.callrecorder.services.recording
...
import com.kkhsmedia.callrecorder.IShellService
...
import com.kkhsmedia.callrecorder.utils.RecordingFileNameFormatter
...
class RecordingForegroundService : Service() {
    companion object {
        ...
        const val ACTION_START_RECORDING = "com.kkhsmedia.callrecorder.START_RECORDING"

        /** Intent action sent to this service to initialize and prepare the recording session in standby mode. */
        const val ACTION_STANDBY = "com.kkhsmedia.callrecorder.STANDBY"

        /** Intent action sent to this service to stop the current recording session and kill the service. */
        const val ACTION_STOP_RECORDING = "com.kkhsmedia.callrecorder.STOP_RECORDING"
        ...
        const val ACTION_PAUSE_RECORDING = "com.kkhsmedia.callrecorder.PAUSE_RECORDING"

        /** Intent action sent to this service to resume the current recording. */
        const val ACTION_RESUME_RECORDING = "com.kkhsmedia.callrecorder.RESUME_RECORDING"


        /**
         * Intent action sent by the standby notification's "Record" button.
         */
        const val ACTION_MANUAL_START = "com.kkhsmedia.callrecorder.MANUAL_START_RECORDING"

        /** Intent action sent to this service when the user dismisses the notification (Android 14+). */
        const val ACTION_NOTIFICATION_DISMISSED = "com.kkhsmedia.callrecorder.SERVICE_NOTIFICATION_DISMISSED"
    }
