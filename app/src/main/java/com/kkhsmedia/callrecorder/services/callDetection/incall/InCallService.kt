...
package com.kkhsmedia.callrecorder.services.callDetection.incall
 ...
 *
 * We can also quickly check that we are binding as NON_UI by running with adb "adb shell telecom is-non-ui-in-call-service-bound com.kkhsmedia.callrecorder" while a call is ongoing.
