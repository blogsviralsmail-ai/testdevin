...
package com.kkhsmedia.callrecorder.services.callDetection.phoneState
...
import com.kkhsmedia.callrecorder.services.RecordingDecisionEngine
...
class PhoneStateSessionManager private constructor(context: Context) {
    ...
    companion object {
        ...
        const val ACTION_DEBUG_IDLE     = "com.kkhsmedia.callrecorder.action.DEBUG_IDLE"
        const val ACTION_DEBUG_RINGING  = "com.kkhsmedia.callrecorder.action.DEBUG_RINGING"
        const val ACTION_DEBUG_OFFHOOK  = "com.kkhsmedia.callrecorder.action.DEBUG_OFFHOOK"
    }
