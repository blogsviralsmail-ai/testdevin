...
package com.kkhsmedia.callrecorder.services
...
import com.kkhsmedia.callrecorder.data.call.CallDirection
import com.kkhsmedia.callrecorder.data.call.EnrichedCallData
import com.kkhsmedia.callrecorder.data.call.RawCallData
import com.kkhsmedia.callrecorder.services.recording.RecordingForegroundService
import com.kkhsmedia.callrecorder.system.permissions.PermissionChecks
import com.kkhsmedia.callrecorder.utils.AppLogger
import com.kkhsmedia.callrecorder.utils.PhoneNumberManager
import com.kkhsmedia.callrecorder.utils.SponsorNotificationHelper
...
class RecordingDecisionEngine private constructor(context: Context) {
     ...
     * 3. Fires the appropriate Intent to [com.kkhsmedia.callrecorder.services.recording.RecordingForegroundService]:
     *    - [com.kkhsmedia.callrecorder.services.recording.RecordingForegroundService.Companion.ACTION_START_RECORDING] if auto-record is enabled
     *    - [com.kkhsmedia.callrecorder.services.recording.RecordingForegroundService.Companion.ACTION_STANDBY] otherwise
     *
     * @param rawData The [RawCallData] received from the OS or third-party source
     * @return true is an Intent to start/standby the [com.kkhsmedia.callrecorder.services.recording.RecordingForegroundService] was fired successfully, false if there was an error
     */
    ...
    /**
     * Ends the current recording session, firing the STOP intent to [com.kkhsmedia.callrecorder.services.recording.RecordingForegroundService].
     */
