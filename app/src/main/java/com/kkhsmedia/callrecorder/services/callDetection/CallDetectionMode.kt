...
package com.kkhsmedia.callrecorder.services.callDetection
...
enum class CallDetectionMode(
    ...
    PhoneState(
        ...
        componentClassName = "com.kkhsmedia.callrecorder.services.callDetection.phoneState.PhoneStateReceiver"
    ),
    InCallService(
        key = "InCallService",
        ...
        componentClassName = "com.kkhsmedia.callrecorder.services.callDetection.incall.InCallService"
    );
